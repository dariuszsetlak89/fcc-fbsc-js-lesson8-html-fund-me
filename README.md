...
```
git clone git@github.com:dariuszsetlak89/fcc-fbsc-js-lesson8-html-fund-me.git
cd fcc-fbsc-js-lesson8-html-fund-me
```
...
You should see a button that says "connect".
